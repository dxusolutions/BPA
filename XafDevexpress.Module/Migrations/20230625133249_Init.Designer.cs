...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XafDevexpress.Module.BusinessObjects.Flow.BackOfficeFlow", b =>
                {
                    b.HasBaseType("XafDevexpress.Module.BusinessObjects.BaseFlow");

                    b.Property<string>("NoteDetail")
                        .HasColumnType("nvarchar(max)");

                    b.ToTable("BackOfficeFlow", (string)null);
                });

            modelBuilder.Entity("XafDevexpress.Module.BusinessObjects.Flow.ConfirmLastDayFlow", b =>
                {
                    b.HasBaseType("XafDevexpress.Module.BusinessObjects.BaseFlow");
                    ...
                    b.ToTable("ConfirmLastDayFlow", (string)null);
                });

            modelBuilder.Entity("XafDevexpress.Module.BusinessObjects.Flow.InterviewFlow", b =>
                {
                    b.HasBaseType("XafDevexpress.Module.BusinessObjects.BaseFlow");
                    ...
                    b.ToTable("InterviewFlow", (string)null);
                });

            modelBuilder.Entity("XafDevexpress.Module.BusinessObjects.Flow.RequestLastDayFlow", b =>
                {
                    b.HasBaseType("XafDevexpress.Module.BusinessObjects.BaseFlow");
                    ...
                    b.ToTable("RequestLastDayFlow", (string)null);
                });

            modelBuilder.Entity("XafDevexpress.Module.BusinessObjects.Flow.ScanCvFlow", b =>
                {
                    b.HasBaseType("XafDevexpress.Module.BusinessObjects.BaseFlow");
                    ...
                    b.ToTable("ScanCvFlow", (string)null);
                });

            modelBuilder.Entity("XafDevexpress.Module.BusinessObjects.Flow.SubmitLastDayFlow", b =>
                {
                    b.HasBaseType("XafDevexpress.Module.BusinessObjects.BaseFlow");
                    ...
                    b.ToTable("SubmitLastDayFlow", (string)null);
                });
            ...
            modelBuilder.Entity("XafDevexpress.Module.BusinessObjects.Flow.BackOfficeFlow", b =>
                {
                    b.HasOne("XafDevexpress.Module.BusinessObjects.BaseFlow", null)
                        .WithOne()
                        .HasForeignKey("XafDevexpress.Module.BusinessObjects.Flow.BackOfficeFlow", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("XafDevexpress.Module.BusinessObjects.Flow.ConfirmLastDayFlow", b =>
                {
                    b.HasOne("XafDevexpress.Module.BusinessObjects.BaseFlow", null)
                        .WithOne()
                        .HasForeignKey("XafDevexpress.Module.BusinessObjects.Flow.ConfirmLastDayFlow", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("XafDevexpress.Module.BusinessObjects.Employee", "Manager")
                        .WithMany()
            ...
            modelBuilder.Entity("XafDevexpress.Module.BusinessObjects.Flow.InterviewFlow", b =>
                {
                    b.HasOne("XafDevexpress.Module.BusinessObjects.BaseFlow", null)
                        .WithOne()
                        .HasForeignKey("XafDevexpress.Module.BusinessObjects.Flow.InterviewFlow", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("XafDevexpress.Module.BusinessObjects.Employee", "Interviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("XafDevexpress.Module.BusinessObjects.Flow.RequestLastDayFlow", b =>
                {
                    b.HasOne("XafDevexpress.Module.BusinessObjects.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeID");

                    b.HasOne("XafDevexpress.Module.BusinessObjects.BaseFlow", null)
                        .WithOne()
                        .HasForeignKey("XafDevexpress.Module.BusinessObjects.Flow.RequestLastDayFlow", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("XafDevexpress.Module.BusinessObjects.Flow.ScanCvFlow", b =>
                {
                    b.HasOne("XafDevexpress.Module.BusinessObjects.BaseFlow", null)
                        .WithOne()
                        .HasForeignKey("XafDevexpress.Module.BusinessObjects.Flow.ScanCvFlow", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("XafDevexpress.Module.BusinessObjects.Flow.SubmitLastDayFlow", b =>
                {
                    ...
                    b.HasOne("XafDevexpress.Module.BusinessObjects.BaseFlow", null)
                        .WithOne()
                        .HasForeignKey("XafDevexpress.Module.BusinessObjects.Flow.SubmitLastDayFlow", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
